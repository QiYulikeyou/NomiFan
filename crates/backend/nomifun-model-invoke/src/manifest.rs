...
const PRESETS: &[PresetSpec] = &[
    ...
    PresetSpec { preset: "ComfyUI", platform: "comfyui", base_url: None, requires_user_input: true, auth_scheme: Some("bearer") },
...
const PROTOCOL_SPECS: &[ProtocolSpec] = &[
    ...
    ProtocolSpec { id: "comfyui.api", tasks: &[ImageGeneration], executor: ModelInvoke, transport: Http, scopes: NATIVE_CUSTOM, platforms: &["comfyui"], connection_role: None, endpoints: &[
        // Local ComfyUI has no API version segment; the version-free convention
        // matches a root like http://127.0.0.1:8188 concatenated with /prompt.
        endpoint(ImageGeneration, "endpoint", Submit, "POST", "/prompt"),
    ] },
